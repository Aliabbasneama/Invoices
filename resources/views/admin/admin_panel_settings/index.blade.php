        ...
        <div class="col-12">
          <div class="card">
           ...
           <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                     <td class="width30">حالة الشركه</td>
                ...
                <tr>
                     <td class="width30"> رسالة التنبيه اعلى الشاشة</td>
                     <td> {{$data['general_alert']}}</td>
                </tr>
                
                <tr>
                     <td class="width30">لوكو الشركة</td>
                     <td> 
                     <div class="image">
                        <img class="custom_img" src="{{asset('assets/admin/uploads').'/'.$data['photo']}}" alt="لوكو الشركه">
                     </div>
