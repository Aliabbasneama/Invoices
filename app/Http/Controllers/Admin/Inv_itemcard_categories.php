...
use Illuminate\Http\Requests\Inv_itemcard_categoriesRequest;
use App\Http\Controllers\Controller;
use App\Http\Requests\AARequest;
...
class Inv_itemcard_categories extends Controller
{
     ...
     */
    public function store(AARequest $request)
    {
        try{
     ...
     */
    public function update($id,AARequest $request)
    {
        try{
            $com_code=auth()->user()->com_code;
            $data=inv_itemcard_categorie::select()->find($id);
